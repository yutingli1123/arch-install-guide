...
export const ui = {
  ...
  hyprlandExtrasHint: {
    zh: 'Hyprland 只提供合成器和会话，以下各类均可单独选择或不安装。',
  },
...
export const choices = {
  ...
  hyprlandAddons: {
    ...
    pavucontrol: { zh: 'pavucontrol' },
    pulsemixer: { zh: 'pulsemixer' },
    playerctl: { zh: 'playerctl' },
...
export const choiceDescriptions = {
  ...
  hyprlandTerminal: {
    none: { zh: '不安装终端，登录后只能通过 TTY 执行命令。' },
  ...
  hyprlandAddons: {
    ...
    satty: { zh: '截图后的标注编辑器，配合 Hyprshot 使用。' },
    'wl-clipboard': { zh: '命令行剪贴板工具 wl-copy 和 wl-paste。' },
    pavucontrol: { zh: '图形音量与设备控制。' },
    pulsemixer: { zh: '终端音量与设备控制。' },
    playerctl: { zh: '媒体播放控制，默认配置的多媒体按键绑定依赖它。' },
